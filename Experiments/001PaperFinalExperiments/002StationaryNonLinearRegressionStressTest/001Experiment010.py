...
from Datasets.Standard.Synthetic.DS005Logarithmic import DS005Logarithmic
...
if __name__ == "__main__":
    ...
    X, y = DS005Logarithmic.DS005_Logarithmic(n_samples, n_features, noise, lower_bound, upper_bound)
