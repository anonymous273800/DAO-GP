...
from Datasets.Standard.Synthetic.DS002Quadratic import DS002Quadratic
...
if __name__ == "__main__":
    ...
    X, y = DS002Quadratic.DS002_Quadratic(n_samples, n_features, noise, lower_bound, upper_bound)
