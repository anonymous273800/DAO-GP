...
from Datasets.Standard.Synthetic.DS009MultipleGaussian import DS009MultipleGaussian
...
if __name__ == "__main__":
    ...
    X, y = DS009MultipleGaussian.DS10_DoubleGaussian(n_samples, n_features, noise, lower_bound, upper_bound, sigma1=0.5, sigma2=0.5, peak_offset=3.0, mix_ratio=0.6)
    ...
    STRETCH_FACTOR = 1
    INITIAL_KERNEL = "rbf"
    MAX_INDUCING = 500  # maximum number of inducing points to retain.
    KPI = 'R2'
    Z = 2.5
