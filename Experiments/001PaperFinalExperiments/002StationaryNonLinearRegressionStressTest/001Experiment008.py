...
from Datasets.Standard.Synthetic.DS004Exponential import DS004Exponential
...
if __name__ == "__main__":
    ...
    X, y = DS004Exponential.DS03_Exponential(n_samples, n_features, noise, lower_bound, upper_bound)
