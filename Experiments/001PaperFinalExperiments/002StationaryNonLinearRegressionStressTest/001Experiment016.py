...
from Datasets.Standard.Synthetic.DS008Gaussian import DS008Gaussian
...
if __name__ == "__main__":
    ...
    X, y = DS008Gaussian.DS008_Gaussian(n_samples, n_features, noise, lower_bound, upper_bound,sigma=1, weight_factor=1.3)
