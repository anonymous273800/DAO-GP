...
if __name__ == "__main__":
    ...
    X, y = PublicDS.get_health_DS(path)
    ...
    fitc_kernel = OnlineFITCGPKernels.CompositeParabolicPeriodicARDRBF(input_dim=n_features,
                                                                       ...
                                                                       period=period)
    fitc_online_gp, fitc_r2_list, fitc_mse_list, fitc_epoch_list = OnlineFITCGPWithOptimization.OnlineFITCGPCaller(
        X_train, y_train, fitc_kernel, MAX_INDUCING,
    ...
    kpa_model, kpa_r2_list, kpa_mse_list, kpa_epoch_list = KPA.kpa(X_train, y_train, kpa_kernel, INCREMENT_SIZE, C=1.0,
                                                                   epsilon=0.1)
    # Final evaluation
