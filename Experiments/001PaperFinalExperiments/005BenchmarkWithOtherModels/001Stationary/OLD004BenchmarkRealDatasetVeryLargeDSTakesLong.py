...
if __name__ == "__main__":
    ...
    X, y = PublicDS.get_parkinsons_telemonitoring_ucirvine_DS(path)
    ...
    fitc_online_gp, fitc_r2_list, fitc_mse_list, fitc_epoch_list = OnlineFITCGP.OnlineFITCGPCaller(X_train, y_train, fitc_kernel, MAX_INDUCING,
                                                              INITIAL_BATCH_SIZE, INCREMENT_SIZE)
    ...
    def kpa_kernel(X1, X2):
        return K001RBF.rbf_kernel_ard(X1,X2,length_scale=1.0)
