...
if __name__ == "__main__":
    ...
    X_base_tr, y_base_tr, K_inv, kernel, kernel_func, kernel_args, noise,\
        ...
        DAOGP.dao_gp(X_train, y_train, INITIAL_BATCH_SIZE, INCREMENT_SIZE, DECAY_GAMMA, MAX_INDUCING, INITIAL_KERNEL, KPI, Z, SAFE_AREA_THRESHOLD, KERNEL_POOL, UNCERTAINTY_THRESHOLD, STRETCH_FACTOR=1)
    ...
    Plotter.plot_final(
        ...
        gamma=DECAY_GAMMA,
        dataset_type="Abrupt Drift (c1: piecewise, c2: parabolic wave)",
        X_test=X_test,
        y_test=y_test,
        noise=noise,
